...
| 3 | P1 | Add MCP permission remediation evidence to operations/timeline APIs | In progress | Capability governance apply now records redacted MCP health refresh evidence, and team runtime timeline now surfaces relevant MCP governance remediation events for MCP servers used by team members; remaining work is broader permission repair actions |
