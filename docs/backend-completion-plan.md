...
- [ ] Support stdio, HTTP/SSE, and hosted MCP adapters behind one internal interface.
  ...
  - [ ] Inject completed self-hosted MCP results into resumed OpenAI tool-call context.
