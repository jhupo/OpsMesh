...
- Existing-name conflicts, missing dependency skips, unsupported export formats, missing archive
...
- Detect disabled skills, missing runtime policies, and quota violations.
