...
from backend.app.domains.capabilities.governance.actions import (
    CapabilityGovernanceActionService,
)
from backend.app.domains.capabilities.governance.read import CapabilityGovernanceReadService
