...
from backend.app.domains.workspace.teams.projects.repository import TeamProjectSpaceRepository
from backend.app.domains.workspace.teams.projects.types import (
    ProjectSpaceRecords,
    relationship_ids,
    runtime_space_ids,
)
