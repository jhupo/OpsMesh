"""Scheduled workspace restore-drill execution."""
    ...
    def run_if_due(
        ...
        *,
        ...
        if interval_hours is None:
            ...
            return restore_drill_skipped_summary(
                workspace.id,
        ...
        try:
            request = scheduled_restore_drill_request(raw_policy)
