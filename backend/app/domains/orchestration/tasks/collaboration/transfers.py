...
from backend.app.domains.orchestration.tasks.collaboration.transfer_package import (
    TaskHandoffPackageBuilder,
)
from backend.app.domains.orchestration.tasks.control.ownership import (
...
class TaskTransferService:
    ...
    def _build_handoff_package(
        ...
        return TaskHandoffPackageBuilder(self._session).build(task, source_id, target_id)
