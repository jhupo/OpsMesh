...
class RuntimeBackend(Protocol):
    ...
    def mcp_adapter(self, runtime: WorkspaceRuntime, run_id: UUID) -> McpToolAdapter: ...


class DockerRuntimeBackend:
    capabilities = RuntimeBackendCapabilities(True, False, True)
...
class SelfHostedRuntimeBackend:
    capabilities = RuntimeBackendCapabilities(True, True, False)
