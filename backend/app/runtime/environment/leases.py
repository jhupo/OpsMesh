...
from backend.app.runtime.environment.metadata import runtime_space_reservation_key
...
class RuntimeLeaseStore:
    """Durable lease state shared by isolated and managed runtime resources."""
