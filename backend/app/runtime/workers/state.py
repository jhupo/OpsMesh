...
class WorkerRunState:
    ...
    def heartbeat_details(self, config: WorkerRunnerConfig) -> dict[str, object]:
        return worker_heartbeat_details(
            ...
            workspace_health_snapshots_created=self.workspace_health_snapshots_created,
            workspace_health_snapshots_skipped=self.workspace_health_snapshots_skipped,
            workspace_health_snapshots_disabled=self.workspace_health_snapshots_disabled,
