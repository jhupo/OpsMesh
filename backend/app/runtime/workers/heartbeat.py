...
def worker_heartbeat_details(
    *,
    ...
    details: dict[str, object] = {
        ...
        "expired_tool_approvals": expired_tool_approvals,
        ...
        "workspace_health_snapshots_created": workspace_health_snapshots_created,
        "workspace_health_snapshots_skipped": workspace_health_snapshots_skipped,
