...
from backend.app.api.routes.platform.dependencies import admin_worker_service
from backend.app.api.routes.platform.responses import page_response
from backend.app.api.schemas.operations.workers import WorkerNodeResponse
from backend.app.api.schemas.platform.admin import AdminWorkerUpdateRequest
