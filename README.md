...
returned DAG before creating execution steps; `input.planning_mode: "deterministic"` explicitly
selects the template planner. Dynamic replanning, ownership transfer and delivery gates remain
tracked separately in that plan; the whole phase is not yet complete.
