...
def signed_headers(
    *, body: bytes, secret: str, timestamp: str, event_id: str,
    event_type: str, delivery_attempt_id: str,
) -> dict[str, str]:
...
def verify_delivery(
    ...
    max_age_seconds: int = 300, now: float | None = None,
) -> str:
    ...
    try:
        ...
        expected = signed_headers(
            body=body, secret=secret, timestamp=timestamp, event_id=event_id,
